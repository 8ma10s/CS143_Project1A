...
LOAD DATA LOCAL INFILE ~/movierating.del INTO TABLE MovieRating FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"';

LOAD DATA LOCAL INFILE ~/sales.del INTO TABLE Sales FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"';
